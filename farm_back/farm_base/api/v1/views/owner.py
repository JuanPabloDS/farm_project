...
from farm_back.farm_base.api.v1.filters import OwnerFilter
from farm_back.farm_base.api.v1.serializers import OwnerListCreateSerializer, OwnerDetailSerializer
